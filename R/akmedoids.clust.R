...
#' value of \code{k}.
#' @usage akmedoids.clust(traj, id_field = FALSE, method = "linear",
...
#' @importFrom ggplot2 ggplot aes geom_line geom_point ggtitle geom_vline
#' @importFrom clusterCrit intCriteria
#' @export


akmedoids.clust <- function(traj, id_field = FALSE, method = "linear",
                            k = c(3,6), crit = "Silhouette"){
