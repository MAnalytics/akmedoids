...
#' \code{'1'}: \code{arithmetic} method, \code{replace_with} options are: \code{'1'}: Mean value of the corresponding column;
#' \code{'2'}: Minimum value of corresponding column; \code{'3'}: Maximum value of corresponding column;
#' \code{'4'}: Mean value of corresponding row; \code{'5'}: Minimum value of corresponding row,
#' or \code{'6'}: Maximum value of corresponding row. For \code{'2'}: regression method:
...
#' trajectories with only one observation. The default is \code{'1'}: Mean value of the corresponding column
...
dataImputation <- function(traj, id_field = FALSE,
